...
This repository contains design files and firmware for the device called PelletMon(itor).

## Design

This project uses it's own PCB. Hardware design is based on ESP8266 (MCU, Wi-Fi, peripherals) and MCP25625 (CAN controller with built in transceiver).
